...
const SalesFormFooter = ({
  ...
  isOnlineOrder, onIsOnlineOrderChange, totalQuantity, unit, subTotal, discount, onDiscountChange, discountType, onDiscountTypeChange,
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center space-x-2">
            <Switch id="online-order" checked={isOnlineOrder} onCheckedChange={onIsOnlineOrderChange} />
            <Label htmlFor="online-order" className="flex items-center gap-2">
              <Truck className="h-4 w-4" /> Is this an Online Order?
            </Label>
          </div>
        </div>
        ...
        <div className="bg-muted p-4 rounded-lg space-y-2 lg:col-span-2">
          ...
          <div className="flex justify-between items-center text-sm">
            <span>Paid</span>
            <span className="font-semibold">RS {(parseFloat(paidAmount) || 0).toFixed(2)}</span>
          </div>
