...
const PurchaseFormFooter = ({
  ...
  totalDiscount, totalCost, balance, onClose, isEdit
}) => {
  return (
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            {isEdit && <p className="text-xs text-muted-foreground mt-1">Editing paid amount will automatically adjust linked payments and ledgers.</p>}
          </div>
          <div>
