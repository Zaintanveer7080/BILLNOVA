          ...
          <tbody>
            {data.map((sale, idx) => (
              <tr key={sale.id} style={{ backgroundColor: idx % 2 === 0 ? '#f9f9f9' : 'white' }}>
                ...
                <td style={{ border: '1px solid #ccc', padding: '8px', textAlign: 'right' }}>RS {sale.revenue.toFixed(2)}</td>
                <td style={{ border: '1px solid #ccc', padding: '8px', textAlign: 'right' }}>RS {sale.itemsCost.toFixed(2)}</td>
                <td style={{ border: '1px solid #ccc', padding: '8px', textAlign: 'right', color: sale.profit >= 0 ? 'green' : 'red' }}>RS {sale.profit.toFixed(2)}</td>
              </tr>
            ))}
          </tbody>
          <tfoot>
            <tr style={{ fontWeight: 'bold', backgroundColor: '#eeeeee' }}>
              ...
              <td style={{ border: '1px solid #ccc', padding: '8px', textAlign: 'right', color: totalProfit >= 0 ? 'green' : 'red' }}>RS {totalProfit.toFixed(2)}</td>
            </tr>
          </tfoot>
        </table>
      </section>
