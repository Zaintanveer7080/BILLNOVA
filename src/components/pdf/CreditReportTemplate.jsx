        ...
        <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '10px' }}>
          ...
          <tbody>
            {data.map((item, idx) => (
              <tr key={item.id} style={{ backgroundColor: idx % 2 === 0 ? '#f9f9f9' : 'white' }}>
                ...
                <td style={{ border: '1px solid #ccc', padding: '8px', textAlign: 'right' }}>RS {item.balance.toFixed(2)}</td>
          ...
          <tfoot>
            <tr style={{ fontWeight: 'bold', backgroundColor: '#eeeeee' }}>
              ...
              <td style={{ border: '1px solid #ccc', padding: '8px', textAlign: 'right' }}>RS {total.toFixed(2)}</td>
