            ...
            {data.map((item, idx) => (
              <React.Fragment key={item.id}>
                <tr style={{ backgroundColor: idx % 2 === 0 ? '#f9f9f9' : 'white', fontWeight: 'bold' }}>
                  ...
                  <td style={{ border: '1px solid #ccc', padding: '8px', textAlign: 'right' }}>RS {item.unitCost.toFixed(2)}</td>
                        ...
                        <tbody>
                          {item.availableSerials.map(serial => (
                            <tr key={serial.serial}>
                              ...
                              <td style={{ border: '1px solid #ddd', padding: '4px', textAlign: 'right' }}>RS {serial.price.toFixed(2)}</td>
