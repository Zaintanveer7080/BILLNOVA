        ...
        <table style={{ width: '100%', borderCollapse: 'collapse' }}>
          ...
          <tbody>
            <tr style={{ backgroundColor: '#f9f9f9' }}>
              ...
              <td style={{ border: '1px solid #ccc', padding: '10px', textAlign: 'right', fontWeight: 'bold' }}>RS {expense.amount.toFixed(2)}</td>
            </tr>
          </tbody>
        </table>
      </section>
      ...
      <section style={{ marginTop: '30px', textAlign: 'right' }}>
        <div style={{ display: 'inline-block', width: '250px' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', padding: '10px 0', borderTop: '1px solid #ccc' }}>
            ...
            <span style={{ fontWeight: 'bold', fontSize: '18px' }}>RS {expense.amount.toFixed(2)}</span>
          </div>
        </div>
      </section>
