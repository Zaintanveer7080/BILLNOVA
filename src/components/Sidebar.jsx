...
import { Home, ShoppingCart, TrendingUp, CreditCard, User, Users, Package, Settings, BarChart2, DollarSign, Banknote, History, LogOut } from 'lucide-react';
...
const navItems = [
  ...
  { name: 'onlineOrders', label: 'Online Orders', icon: Banknote },
    ...
    >
      ...
      <div className="px-2 py-4">
        <motion.a
            href="#"
            onClick={() => signOut()}
            className={`flex items-center p-3 rounded-lg transition-colors duration-200 hover:bg-red-500/20 text-red-400 hover:text-red-300 ${!isExpanded ? 'justify-center' : ''}`}
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
        >
