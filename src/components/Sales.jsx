...
function Sales() {
  ...
  const { sales, customers, items, payments, banks, cashInHand, onlineOrders } = data;
  ...
  const handleDelete = (id) => {
    requestPasscode(() => {
        ...
        const updatedOnlineOrders = onlineOrders.filter(o => o.saleId !== id);
        updateData({ sales: updatedSales, payments: updatedPayments, cashInHand: updatedCashInHand, banks: updatedBanks, onlineOrders: updatedOnlineOrders });
